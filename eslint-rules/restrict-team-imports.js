...
const restrictTeamImports = {
    ...
    create(context) {
        ...
        const options = {
            allowedGlobalFolders: userOptions?.allowedGlobalFolders ?? DEFAULT_OPTIONS.allowedGlobalFolders,
